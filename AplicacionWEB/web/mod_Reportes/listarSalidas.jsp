...
<%
 ...
 List<Reporte> listasalida=FReporte.reporte_salida();
 Iterator<Reporte> itReporte=listasalida.iterator();
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    if (alerta.equals("si")){%>
       ...
       <% }if (alerta.equals("acceso_denegado")){%>
        ...
        <tbody>
            ...
            <tr>
                <td><%= reporte.getFecha_salida()%></td>
                <td><%= reporte.getNombre_producto()%></td>                
                <td><%= reporte.getCantidad_salida()%></td>
                <td><%= reporte.getNombre_destino()%></td>                
            </tr>
            <%}%>                
        </tbody>           
    </table>       
